...
export IMAGE_URL=${IMAGE_URL-quay.io/rhtap_qe/go-eomvbkra:$CI_TYPE-$TAG}
...
export GITOPS_REPO_URL=https://github.com/rhtap-rhdh-qe/go-eomvbkra-gitops
...
export COSIGN_PUBLIC_KEY="LS0tLS1CRUdJTiBQVUJMSUMgS0VZLS0tLS0KTUZrd0V3WUhLb1pJemowQ0FRWUlLb1pJemowREFRY0RRZ0FFU1BFNFp0WUxjL0lDdk9jVDhJVmJ2TGlteFdmZgpvV25QeHlTRThrdXlpRHdUdU5INEd5Nkl3UG1jMi91Y3VNL0dhYm5qNmJ3cnU4S0d5LzZubmN1aDl3PT0KLS0tLS1FTkQgUFVCTElDIEtFWS0tLS0tCg=="
...
export REKOR_HOST=${REKOR_HOST-https://rekor-server-tssc-tas.apps.rosa.kx-2daebd30a3.5fiz.p3.openshiftapps.com}
...
export TUF_MIRROR=${TUF_MIRROR-https://tuf-tssc-tas.apps.rosa.kx-2daebd30a3.5fiz.p3.openshiftapps.com}
